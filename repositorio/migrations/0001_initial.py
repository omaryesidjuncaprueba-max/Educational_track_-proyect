# Generated by Django 4.2.30 on 2026-05-13 16:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('Estudiante', 'Estudiante'), ('Docente', 'Docente'), ('Coordinador', 'Coordinador'), ('Jurado', 'Jurado')], default='Estudiante', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo', models.FileField(upload_to='proyectos_pdfs/')),
                ('fecha_subida', models.DateTimeField(auto_now_add=True)),
                ('estado', models.CharField(default='Pendiente', max_length=20)),
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repositorio.categoria')),
            ],
        ),
    ]
